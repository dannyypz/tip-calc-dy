...
console.log(`Thhe tip should be $${totalAmountToTip.toFixed(2)}`);
console.log(`The Toals Check would be $${billWithTip.toFixed(2)}`);
console.log(`The total tip per person${totalPerPerson.toFixed(2)}`);